        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="header-content">
                    ...
                    <p>
                        <?php if(!isset($_SESSION['login'])): ?>
                            <a href="index.php?ctr=login" onclick="return window.confirm('You must login to use this feater!')">Get start now!</a>
                        <?php else: ?>
                            <a href="index.php?ctr=create_post">Get start now!</a>
                        <?php endif; ?>
                    </p>
                </div>
                <!-- Main menu -->
                <div class="main-menu">
                    <ul class="row">
                        ...
                        <li class="col-2 col-m-2"><a href="index.php">Tops Posts</a></li>
                        <li class="col-2 col-m-2"><a href="#">My Clips</a></li>
                        <li class="col-2 col-m-2"><a href="index.php?ctr=topics_all">All Topics</a></li>
                        <li class="col-2 col-m-2"><a href="index.php?ctr=authors_all">Top Authors</a></li>
            ...
            <div class="main row">
                ...
                <div class="sidebar col-3 col-m-3">
                    <!-- Top Authors -->
                    <div class="title">
                        <a href="index.php?ctr=authors_all">Top Authors</a>
                    </div>
                            ...
                            for($i=0; $i<count($topAuthors); $i++) {
                                ...
                                <div class="sidebar-item">
                                    <div class="sidebar-info clearfix">
                                        ...
                                        <div>
                                            <a href="index.php?ctr=authors_all&act=detail&author_id=<?php echo $authorID; ?>">
                                            ...
                                            <?php
                                                if(!isset($_SESSION['login'])) : ?>
                                                    <a href="index.php?ctr=login" title="Like this post"
                                                        onclick="return window.confirm('You must login to use this feater!')"
                                                        class="<?php echo $className[$topPosts[$i]['id']]; ?>"
                        ...
                        foreach ($posts as $key => $value) {
                            ...
                            <div class="item-post">
                                <div class="author-post clearfix">
                                        ...
                                        <div>
                                            <a href="index.php?ctr=authors_all&act=detail&author_id=<?php echo $author[$post_id]['id']; ?>">
                                                <?=$authorName?>
                                            </a>
                                        </div>
                                    <p class="time-post">
                                ...
                                foreach ($tpNames as $t => $n) {
                                    ?>
                                        <a class="topic-name" href="index.php?ctr=topic_one&topic_id=<?php echo $tpId[$t];?>">
                                             <?=$n?>
                                        </a>
                                    <?php
                                }
