...
<html>
    <head>
        ...
        <link rel="stylesheet" href="public/css/topic_one.css">
        ...
        <div class="container">
            ...
            <div class="main row">
                ...
                <div class="main-content col-9 col-m-9">
                    <div class="title-topic clearfix">
                            <?php
                                if($thisTopic['logo']!=""){
                                    ?>
                                    <a href="index.php?ctr=topic_one&topic_id=<?php echo $thisTopic['id']; ?>">
                                        <div class="logo-topic-image">
                                            <img width="100px" height="100px"
                                                src="<?php echo $thisTopic['logo']?>" alt="<?php echo $thisTopic['name']; ?>">
                                        </div>
                                    </a>
                                    <?php
                                } else {
                        ...
                        <div class="info-topic">
                            ...
                            <p>
                                <b><?php echo $thisTopic['quatity_post'];?></b> posts
                            </p>
                            <p>
                                <b><?php echo $thisTopic['quatity_member'];?></b> members
                            </p>
                            <a href="#">FOLLOW</a>
                        </div>
                    </div>
                    <?php
                        if(count($posts)==0){
                            ?>
                            <div class="item-post">
                                <p style="text-align: center">There is no post.</p>
                            </div>
                            <?php
                        } else {
