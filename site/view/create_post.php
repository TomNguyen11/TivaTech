    ...
    <body>
        ...
        <div class="main-post row">
            ...
            <div class="main-content col-12 col-m-12">
                <form class="" action="index.php?ctr=create_post&act=create" method="post">
                    <!-- Title of the post -->
                    <?php
                    ...
                    <input type="text" name="title" id="title-post" value="" placeholder="Title">
                    <input autocomplete="off" list="allTopicNames" type="text" name="topics" id="topics" value="" placeholder="Topics">
